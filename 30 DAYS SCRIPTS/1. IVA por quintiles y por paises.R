...
vat <- read.csv("DATOS/NUTS/distribucion VAT.csv", na = ":")
...
ingresos <- read.csv("DATOS/nama_10_gdp_1_Data.csv", na = ":")
...
ggplot(grupo)+
  ...
  labs(x="",
       y="",
       title = "Distribución del IVA pagado por los hogares como porcentaje de sus ingresos brutos por quintil de ingresos",
